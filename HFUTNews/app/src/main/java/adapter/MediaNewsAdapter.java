...
public class MediaNewsAdapter extends BaseAdapter{
    private ArrayList<MediaNewsModel> arrayList;
    private Context context;

    public MediaNewsAdapter(ArrayList<MediaNewsModel> arrayList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MediaNewsModel newsBean = arrayList.get(position);
        //4.将数据设置给这些子控件做显示
