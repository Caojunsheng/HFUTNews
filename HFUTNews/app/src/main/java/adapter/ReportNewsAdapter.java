...
public class ReportNewsAdapter extends BaseAdapter {
    ...
    private ArrayList<ReportNewsModel> arrayList;
    private Context context;

    public ReportNewsAdapter(ArrayList<ReportNewsModel> arrayList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ReportNewsModel newsBean = arrayList.get(position);
        //4.将数据设置给这些子控件做显示
